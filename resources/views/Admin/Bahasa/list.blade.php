    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <div class="title" style="color: white;">
                <h4 style="color: white;">Data Bahasa</h4>
            </div>
            <p>Home / Data Bahasa</p>
        </div>
    </div>
</div>
...
<form action="{{ route('tambah/bahasa') }}" method="post" enctype="multipart/form-data">
    @csrf
    <p>Tambah Bahasa Baru</p>
        ...
        foreach ($data as $row) : ?>
            <tr>
                ...
                <td class="action-buttons">
                    ...
                    <form action="{{ route('hapus/bahasa', ['id' => $row->id]) }}" method="post" style="display: inline;">
                        @csrf
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('update/bahasa', ['id' => $row->id]) }}" method="post">
                                @csrf
                                <input type="hidden" name="id" value="<?= $row->id ?>">
                                <input type="text" name="bahasa" value="<?= $row->bahasa ?>" required class="form-control">
                                <br>
