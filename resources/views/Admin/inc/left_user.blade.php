    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                <li>
                    <a href="/user/dashboard" class="dropdown-toggle no-arrow">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="/daftar/kelas" data-key="daftar_kelas">Daftar Kelas</a></li>
                        <li><a href="/history/transaksi" data-key="transaksi_anda">ahahahah</a></li>
                        <li><a href="/kelas/aktif" data-key="kelas_anda">jeg menyala wi</a></li>
