        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">Selamat Datang Kembali</div>
                    <div class="intro-x mt-8">
                        <!-- awal form -->
                        <form action="{{ route('processLoginuser') }}" method="post" enctype="multipart/form-data">
                            @csrf
                        ...
                        <!-- akhir form -->
                      <a href="/register" target="_blank"><button type="button" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Register</button></a>
                        </div>
